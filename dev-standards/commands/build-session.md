...
Look for the project's canonical documents — `DECISIONS.md`, `ASSUMPTIONS.md`, `HANDOFF.md`, and any contract doc named by the user — and read the entries that touch this session's work.
